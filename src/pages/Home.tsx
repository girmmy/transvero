...
const Home: React.FC = () => {
  ...
  const features = [
    ...
    {
      icon: <FiClock className="h-8 w-8 text-blue-600" />,
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md sm:max-w-none mx-auto px-4">
              {user ? (
                <>
                  <Link
                    to="/dashboard"
                    className="bg-blue-600 text-white px-6 sm:px-8 py-3 rounded-lg text-base sm:text-lg font-medium hover:bg-blue-700 transition-colors"
                  >
                    Go to Dashboard
                  </Link>
                  <Link
                    to="/live"
                    className="bg-white text-blue-600 border-2 border-blue-600 px-6 sm:px-8 py-3 rounded-lg text-base sm:text-lg font-medium hover:bg-blue-50 transition-colors"
                  >
                    Start New Session
                  </Link>
                </>
      ...
      <section className="bg-blue-600 py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to={user ? "/live" : "/signup"}
            className="bg-white text-blue-600 px-6 sm:px-8 py-3 rounded-lg text-base sm:text-lg font-medium hover:bg-gray-100 transition-colors inline-block"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-xl sm:text-2xl font-bold mb-4">
              <span className="text-blue-400">Trans</span>vero
            </h3>
