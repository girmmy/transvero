...
const Dashboard: React.FC = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: <FiMic className="h-6 w-6 text-purple-600" />,
        ...
        <div className="mb-4 sm:mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-9 sm:pl-10 pr-3 py-2 sm:py-3 border border-gray-300 rounded-md leading-5 bg-white placeholder-gray-500 focus:outline-none focus:placeholder-gray-400 focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base"
            />
          </div>
        </div>
        ...
        {filteredTranscripts.length > 0 ? (
          ...
          <div className="text-center py-8 sm:py-12">
            <div className="mx-auto h-16 w-16 sm:h-24 sm:w-24 bg-gray-100 rounded-full flex items-center justify-center mb-4">
              <FiFileText className="h-8 w-8 sm:h-12 sm:w-12 text-gray-400" />
            </div>
